...
function SimpleFormExample() {
    ...
    onSubmit={handleSubmit((_data) => console.info(_data))}>
				<div className="mt-48 mb-16">
					...
					<input className={clsx('border-1 outline-none rounded-lg p-8', !!errors.Native && 'border-red')} {...register('Native')} required/>

					{!!errors.Native && (<Typography className="px-4 py-8 font-medium text-base" color="error">
				...
				<div className="mt-48 mb-16">
					<Controller name="Checkbox" control={control} render={({ field: { onChange, value, onBlur, ref } }) => (<FormControl error={!!errors.Checkbox} required>
								<FormLabel className="font-medium text-base" component="legend">
									MUI Checkbox
								</FormLabel>
			...
			<div className="w-1/2 my-48 p-24">
				...
				<div className="mb-12">
					<Typography className="mt-16 font-medium text-md italic" color="text.secondary">
